...
#define SIN1_HIGH() HAL_GPIO_WritePin(GPIOA, SIN1_Pin, GPIO_PIN_SET)
#define SIN1_LOW() HAL_GPIO_WritePin(GPIOA, SIN1_Pin, GPIO_PIN_RESET)
#define CLK1_HIGH() HAL_GPIO_WritePin(GPIOC, CLK1_Pin, GPIO_PIN_SET)
#define CLK1_LOW() HAL_GPIO_WritePin(GPIOC, CLK1_Pin, GPIO_PIN_RESET)
...
#define SIN4_HIGH() HAL_GPIO_WritePin(GPIOB, SIN4_Pin, GPIO_PIN_SET)
#define SIN4_LOW() HAL_GPIO_WritePin(GPIOB, SIN4_Pin, GPIO_PIN_RESET)
#define CLK4_HIGH() HAL_GPIO_WritePin(GPIOA, CLK4_Pin, GPIO_PIN_SET)
#define CLK4_LOW() HAL_GPIO_WritePin(GPIOA, CLK4_Pin, GPIO_PIN_RESET)
